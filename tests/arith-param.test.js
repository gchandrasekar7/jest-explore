...
test('divide by 0 exception', () => {
    // test for exact error
    expect(() => div(1,0)).toThrow(new Error("you are trying to divide by 0!!!"));
    // test if error contains substring
    expect(() => div(1,0)).toThrow("you are trying to divide by 0!!!");
});